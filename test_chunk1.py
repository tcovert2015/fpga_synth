"""
Test suite for Chunk 1: Lexer, Parser, AST, and Netlist IR.

Run with: python -m pytest fpga_synth/tests/test_chunk1.py -v
Or:       python fpga_synth/tests/test_chunk1.py
"""
